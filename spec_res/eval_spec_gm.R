...
load("results_norm1_grandmean.RData")
...
pdf(file = "unweighted_norm_1_sev_cor_gm.pdf", width = 10, height = 15)
print(p_dat_11)
dev.off()
sink(file = "norm_1_gm.txt")
...
load("results_pois1_grandmean.RData")
...
pdf(file = "weighted_pois_1_mid_cor_gm.pdf", width = 10, height = 15)
print(p_dat_11)
dev.off()
sink(file = "pois_1_gm.txt")
write_longtable(dat_1, 1)
sink()
...
load("results_beta4_grandmean.RData")
...
pdf(file = "unweighted_beta_4_no_cor_gm.pdf", width = 10, height = 15)
print(p_dat_11)
dev.off()
sink(file = "beta_4_gm.txt")
...
load("results_norm5_grandmean.RData")
...
pdf(file = "unweighted_norm_5_mid_cor_gm.pdf", width = 10, height = 15)
print(p_dat_11)
dev.off()

sink(file = "norm_5_gm.txt")
...
# Power -------------------------------------------------------------------
   ...
   #-- Norm
   load("pow_list_norm_grandmean.RData")
   ...
   for(i in 1:length(unique(pow_list_norm$mu))){
      ...
      pdf(file = paste0("norm_1_sev_mu_", unique(dat$mu)[i], "_gm.pdf"), width = 10, height = 15)
      print(p_dat_11)
      dev.off()
      
      sink(file = paste0("norm_1_sev_mu_", unique(dat$mu)[i], "_gm.txt"))
      write_longtable(dat_1, 1)
      sink()
   }
   
   #-- Pois
   load("pow_list_pois_grandmean.RData")
   ...
   for(i in 1:length(unique(pow_list_pois$lambda))){
      ...
      pdf(file = paste0("pois_5_mid_lambda_", unique(dat$lambda)[i], "_gm.pdf"), width = 10, height = 15)
      print(p_dat_11)
      dev.off()
      
      sink(file = paste0("pois_5_mid_lambda_", unique(dat$lambda)[i], "_gm.txt"))
      write_longtable(dat_1, 1)
      sink()
   }
